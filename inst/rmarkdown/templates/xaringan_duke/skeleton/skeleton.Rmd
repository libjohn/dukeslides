...
Use `.content-box-blue` to produce a box with blue background. Size depends on content.  color has the following options:  `.content-box-color` where color is   blue | gray | gey | neutral | duke-green | green | purple | red | yellow
...
I think the term "template" is ambiguous here.  You can follow the documentation.  Just know, there are R Markdown templates and then there are Remark.js templates.  Look at the next link for the definition of the Remark.js templates.  [Incremental slides documentation](https://slides.yihui.name/xaringan/incremental.html).
