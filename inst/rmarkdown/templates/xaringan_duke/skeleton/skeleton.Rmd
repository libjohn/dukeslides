...
This example slide deck extends the excellent collaborative work of the xaringan and Remark.js slide tools.  With this template, slide authors can compose xaringan slides using [R Markdown](https://rmarkdown.rstudio.com/) to present [Duke University branding](https://styleguide.duke.edu/color-palette/).
...
Most of the cheat sheet examples will get displayed in the slide itself.  Some of the example code will be found in the presenter notes.  The full detailed R Markdown can always be displayed by opening the rendered HTML slides in your web browser and `View Source`.  You can access the presenter notes by pressing the keyboard shortcut `p`.  (`?` for other shortcuts)
...
- Duke color palette overlaid on Hygge CSS, (`hygge-duke.css`)
...
# inside of an R Markdown code chunk
#
...
(just like any R Markdown document)
